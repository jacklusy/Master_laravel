                        ...
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="product_tags" data-role="tagsinput" value="{{$products->product_tags}}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label">Product Size</label>
                                        <input type="text" class="form-control" name="product_size" data-role="tagsinput" value="{{$products->product_size}}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label">Product Color</label>
                                        <input type="text" class="form-control" name="product_color" data-role="tagsinput" value="{{$products->product_color}}">
                                    </div>
                        ...
                        <form method="POST" action="{{route('update.product.multiImage')}}" enctype="multipart/form-data">
                            ...
                            @foreach ($multiImage as $key => $img)
                                <tr>
                                    ...
                                    <td><img src="{{ asset($img->photo_name)}}" style="width:100px; height:100px;" alt=""></td>
